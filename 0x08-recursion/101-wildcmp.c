...
int wildcmp(char *s1, char *s2)
{
	 ...
	 * of wildcmp() to sum
	 * add the return value of goandfind() to sum
...
/**
 * goandfind - checks recursively for all the paths when the
